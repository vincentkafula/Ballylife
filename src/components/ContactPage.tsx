        ...
        <div>
          ...
          <div class="bl-region-cols">
            ...
            <div class="bl-region">
              <h5>East Africa</h5>
              <ul>
                <li class="bl-country" data-country="Burundi" tabindex="0" role="button">Burundi</li><li class="bl-country" data-country="Comoros" tabindex="0" role="button">Comoros</li><li class="bl-country" data-country="Djibouti" tabindex="0" role="button">Djibouti</li><li class="bl-country" data-country="Eritrea" tabindex="0" role="button">Eritrea</li><li class="bl-country" data-country="Ethiopia" tabindex="0" role="button">Ethiopia</li><li class="bl-country" data-country="Kenya" tabindex="0" role="button">Kenya</li><li class="bl-country" data-country="Madagascar" tabindex="0" role="button">Madagascar</li><li class="bl-country" data-country="Malawi" tabindex="0" role="button">Malawi</li><li class="bl-country" data-country="Mauritius" tabindex="0" role="button">Mauritius</li><li class="bl-country" data-country="Mozambique" tabindex="0" role="button">Mozambique</li><li class="bl-country" data-country="Rwanda" tabindex="0" role="button">Rwanda</li><li class="bl-country" data-country="Seychelles" tabindex="0" role="button">Seychelles</li><li class="bl-country" data-country="Somalia" tabindex="0" role="button">Somalia</li><li class="bl-country" data-country="South Sudan" tabindex="0" role="button">South Sudan</li><li class="bl-country" data-country="Tanzania" tabindex="0" role="button">Tanzania</li><li class="bl-country" data-country="Uganda" tabindex="0" role="button">Uganda</li><li class="bl-country" data-country="Zambia" tabindex="0" role="button">Zambia</li><li class="bl-country" data-country="Zimbabwe" tabindex="0" role="button">Zimbabwe</li>
              </ul>
            </div>
            <div class="bl-region">
              <h5>Central Africa</h5>
              <ul>
                <li class="bl-country" data-country="Angola" tabindex="0" role="button">Angola</li><li class="bl-country" data-country="Cameroon" tabindex="0" role="button">Cameroon</li><li class="bl-country" data-country="Central African Republic" tabindex="0" role="button">Central African Republic</li><li class="bl-country" data-country="Chad" tabindex="0" role="button">Chad</li><li class="bl-country" data-country="Republic of the Congo" tabindex="0" role="button">Republic of the Congo</li><li class="bl-country" data-country="Democratic Republic of the Congo" tabindex="0" role="button">Democratic Republic of the Congo</li><li class="bl-country" data-country="Equatorial Guinea" tabindex="0" role="button">Equatorial Guinea</li><li class="bl-country" data-country="Gabon" tabindex="0" role="button">Gabon</li><li class="bl-country" data-country="Sao Tome and Principe" tabindex="0" role="button">Sao Tome and Principe</li>
              </ul>
              <div class="bl-region" style="margin-top:22px;">
                <h5>Southern Africa</h5>
                <ul>
                  <li class="bl-country" data-country="Botswana" tabindex="0" role="button">Botswana</li><li class="bl-country" data-country="Eswatini (Swaziland)" tabindex="0" role="button">Eswatini (Swaziland)</li><li class="bl-country" data-country="Lesotho" tabindex="0" role="button">Lesotho</li><li class="bl-country" data-country="Namibia" tabindex="0" role="button">Namibia</li><li class="bl-country" data-country="South Africa" tabindex="0" role="button">South Africa</li>
                </ul>
              </div>
            </div>
          </div>
