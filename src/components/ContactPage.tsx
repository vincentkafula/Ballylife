...
<section class="bl-contact">
  <style>
    ...
    .bl-countries-head{display:flex; align-items:center; gap:10px; margin-bottom:24px;}
    .bl-countries-head svg{flex:0 0 auto;}
    .bl-region-cols{display:grid; grid-template-columns:repeat(3,1fr); gap:20px;}
    .bl-region h5{color:var(--bl-orange); font-size:14.5px; margin:0 0 10px; font-weight:700;}
    .bl-region ul li{
      font-size:13.5px; color:var(--bl-text); padding:3px 0; position:relative; padding-left:14px;
    }
    .bl-region ul li::before{
      content:"•"; color:var(--bl-green); position:absolute; left:0; top:3px; font-size:12px;
    }
    .bl-region + .bl-region{margin-top:22px;}
    .bl-country{
      cursor:pointer; border-radius:4px; transition:color .12s ease, padding-left .12s ease;
    }
    .bl-country:hover,
    ...
    @media (max-width:760px){
      ...
      .bl-region-cols{grid-template-columns:1fr 1fr;}
    ...
    <div class="bl-wrap">
      <div class="bl-grid">
        ...
        <div>
          ...
          <div class="bl-region-cols">
            <div class="bl-region">
              <h5>North Africa</h5>
              <ul>
                <li class="bl-country" data-country="Algeria" tabindex="0" role="button">Algeria</li><li class="bl-country" data-country="Egypt" tabindex="0" role="button">Egypt</li><li class="bl-country" data-country="Libya" tabindex="0" role="button">Libya</li><li class="bl-country" data-country="Morocco" tabindex="0" role="button">Morocco</li><li class="bl-country" data-country="Sudan" tabindex="0" role="button">Sudan</li><li class="bl-country" data-country="Tunisia" tabindex="0" role="button">Tunisia</li><li class="bl-country" data-country="Western Sahara" tabindex="0" role="button">Western Sahara</li>
              </ul>
              <div class="bl-region" style="margin-top:22px;">
                <h5>West Africa</h5>
                <ul>
                  <li class="bl-country" data-country="Benin" tabindex="0" role="button">Benin</li><li class="bl-country" data-country="Burkina Faso" tabindex="0" role="button">Burkina Faso</li><li class="bl-country" data-country="Cabo Verde" tabindex="0" role="button">Cabo Verde</li><li class="bl-country" data-country="Cote d'Ivoire" tabindex="0" role="button">Cote d'Ivoire</li><li class="bl-country" data-country="Gambia" tabindex="0" role="button">Gambia</li><li class="bl-country" data-country="Ghana" tabindex="0" role="button">Ghana</li><li class="bl-country" data-country="Guinea" tabindex="0" role="button">Guinea</li><li class="bl-country" data-country="Guinea-Bissau" tabindex="0" role="button">Guinea-Bissau</li><li class="bl-country" data-country="Liberia" tabindex="0" role="button">Liberia</li><li class="bl-country" data-country="Mali" tabindex="0" role="button">Mali</li><li class="bl-country" data-country="Mauritania" tabindex="0" role="button">Mauritania</li><li class="bl-country" data-country="Niger" tabindex="0" role="button">Niger</li><li class="bl-country" data-country="Nigeria" tabindex="0" role="button">Nigeria</li><li class="bl-country" data-country="Senegal" tabindex="0" role="button">Senegal</li><li class="bl-country" data-country="Sierra Leone" tabindex="0" role="button">Sierra Leone</li><li class="bl-country" data-country="Togo" tabindex="0" role="button">Togo</li>
                </ul>
              </div>
            </div>
            <div class="bl-region">
              <h5>East Africa</h5>
              <ul>
                <li class="bl-country" data-country="Burundi" tabindex="0" role="button">Burundi</li><li class="bl-country" data-country="Djibouti" tabindex="0" role="button">Djibouti</li><li class="bl-country" data-country="Eritrea" tabindex="0" role="button">Eritrea</li><li class="bl-country" data-country="Ethiopia" tabindex="0" role="button">Ethiopia</li><li class="bl-country" data-country="Kenya" tabindex="0" role="button">Kenya</li><li class="bl-country" data-country="Rwanda" tabindex="0" role="button">Rwanda</li><li class="bl-country" data-country="Somalia" tabindex="0" role="button">Somalia</li><li class="bl-country" data-country="South Sudan" tabindex="0" role="button">South Sudan</li><li class="bl-country" data-country="Uganda" tabindex="0" role="button">Uganda</li>
              </ul>
            </div>
            <div class="bl-region">
              <h5>Central Africa</h5>
              <ul>
                <li class="bl-country" data-country="Cameroon" tabindex="0" role="button">Cameroon</li><li class="bl-country" data-country="Central African Republic" tabindex="0" role="button">Central African Republic</li><li class="bl-country" data-country="Chad" tabindex="0" role="button">Chad</li><li class="bl-country" data-country="Republic of the Congo" tabindex="0" role="button">Republic of the Congo</li><li class="bl-country" data-country="Equatorial Guinea" tabindex="0" role="button">Equatorial Guinea</li><li class="bl-country" data-country="Gabon" tabindex="0" role="button">Gabon</li><li class="bl-country" data-country="Sao Tome and Principe" tabindex="0" role="button">Sao Tome and Principe</li>
              </ul>
              <div class="bl-region" style="margin-top:22px;">
                <h5>Southern Africa (SADC)</h5>
                <ul>
                  <li class="bl-country" data-country="Angola" tabindex="0" role="button">Angola</li><li class="bl-country" data-country="Botswana" tabindex="0" role="button">Botswana</li><li class="bl-country" data-country="Comoros" tabindex="0" role="button">Comoros</li><li class="bl-country" data-country="Democratic Republic of the Congo" tabindex="0" role="button">Democratic Republic of the Congo</li><li class="bl-country" data-country="Eswatini (Swaziland)" tabindex="0" role="button">Eswatini (Swaziland)</li><li class="bl-country" data-country="Lesotho" tabindex="0" role="button">Lesotho</li><li class="bl-country" data-country="Madagascar" tabindex="0" role="button">Madagascar</li><li class="bl-country" data-country="Malawi" tabindex="0" role="button">Malawi</li><li class="bl-country" data-country="Mauritius" tabindex="0" role="button">Mauritius</li><li class="bl-country" data-country="Mozambique" tabindex="0" role="button">Mozambique</li><li class="bl-country" data-country="Namibia" tabindex="0" role="button">Namibia</li><li class="bl-country" data-country="Seychelles" tabindex="0" role="button">Seychelles</li><li class="bl-country" data-country="South Africa" tabindex="0" role="button">South Africa</li><li class="bl-country" data-country="Tanzania" tabindex="0" role="button">Tanzania</li><li class="bl-country" data-country="Zambia" tabindex="0" role="button">Zambia</li><li class="bl-country" data-country="Zimbabwe" tabindex="0" role="button">Zimbabwe</li>
                </ul>
              </div>
            </div>
          </div>
...
export function ContactPage({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      ...
      <iframe
        ref={iframeRef}
        title="Contact Ballylife"
        srcDoc={CONTACT_PAGE_HTML}
